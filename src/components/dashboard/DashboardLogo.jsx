...
function DashboardLogo() {
  return (
    <Link
      ...
      className="group inline-flex items-center gap-2 rounded-2xl px-1 py-1 transition hover:opacity-90"
    >
      {" "}
      <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-[#EAECF0] transition group-hover:ring-[#D9E2FF]">
        {" "}
        <svg
          width="28"
          height="28"
      ...
      <span className="hidden leading-tight sm:block">
        {" "}
        <span className="block text-sm font-semibold tracking-tight text-[#101828]">
          {" "}
          Contribute{" "}
        </span>{" "}
